"""
Single-seed version of Optuna tuning for parallel execution across multiple GPUs.

Usage:
    python optuna_tune_single_seed.py --seed 0 --device 0 --n_trials 200
    python optuna_tune_single_seed.py --seed 1 --device 1 --n_trials 200
    python optuna_tune_single_seed.py --seed 2 --device 2 --n_trials 200
    ...
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description='FlexMoE Optuna Tuning - Single Seed')
...
def main():
    ...
    print(f"\n{'='*80}")
    print(f"Running hyperparameter tuning for seed {seed_idx} on GPU {args.device}")
    print(f"{'='*80}\n")
